    ...
    public function __construct(string $content, bool $useIsolate = false)
    {
        ...
        if ($useIsolate) {
            ...
            */
            ...
            $this->isolateCmd = "/usr/local/bin/isolate --box-id 6969 --cg --cg-mem=512000 --cg-timing --time=5 --wall-time=5 --extra-time=5 --mem=512000 --processes=4 --dir=/usr:maybe --dir=/etc:maybe --dir=/var:maybe --env=PATH=/bin:/usr/bin:/usr/sbin";
