...
&& \
apt-fast install -y \
php7.4 php7.4-fpm php7.4-cli php7.4-common php7.4-opcache ssh htop make git gcc g++ make dvipng imagemagick libcap-dev texlive texlive-base vim \
&& \
mkdir -v /root/.ssh \
&& \
...
&& \
/bin/echo "invalid:x:66969:invalid" >> /etc/group \
&& \
/bin/echo "invalid:x:66969:66969:Invalid,,,:/box/latex:/bin/bash" >> /etc/passwd;
